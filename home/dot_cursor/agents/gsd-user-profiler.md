...
<reference>
@$HOME/.cursor/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `$HOME/.cursor/get-shit-done/references/user-profiling.md` to load:
