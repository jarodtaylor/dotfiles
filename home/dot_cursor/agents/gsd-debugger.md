...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  ...
                  → checks $HOME/.cursor/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = $HOME/.cursor/get-shit-done
                  → writes to $HOME/.cursor/get-shit-done/hooks/
...
@$HOME/.cursor/get-shit-done/references/thinking-models-debug.md
...
- Read @$HOME/.cursor/get-shit-done/references/common-bug-patterns.md
...
```bash
INIT=$(node "$HOME/.cursor/get-shit-done/bin/gsd-tools.cjs" state load)
...
```bash
node "$HOME/.cursor/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "$HOME/.cursor/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```
