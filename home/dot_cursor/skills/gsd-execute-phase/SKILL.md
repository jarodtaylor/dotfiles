...
<execution_context>
@$HOME/.cursor/get-shit-done/workflows/execute-phase.md
...
<process>
Execute the execute-phase workflow from @$HOME/.cursor/get-shit-done/workflows/execute-phase.md end-to-end.
